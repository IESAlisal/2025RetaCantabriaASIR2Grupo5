    ...
    <div class="form-editar">
        ...
        <form method="POST">
            ...
            <div class="form-buttons">
                ...
                <a href="asignaturas.php" class="btn-cancelar" style="text-decoration: none; text-align: center;">Cancelar</a>
            </div>
        </form>
    </div>
    <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <div class="asignatura-item">
                ...
                <div class="asignatura-actions">
                    <a href="asignaturas.php?editar=<?php echo $asig['id_asignatura']; ?>" class="btn btn-editar">Editar</a>
